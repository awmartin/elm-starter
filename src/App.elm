...
import Model exposing (Model, emptyModel, FirebaseProjectsList, FirebaseTodosList)
...
port projects : (FirebaseProjectsList -> msg) -> Sub msg
port todos : (FirebaseTodosList -> msg) -> Sub msg
...
subscriptions model =
    ...
    Sub.batch [
        projects Msg.FirebaseProjectsListUpdate,
        todos Msg.FirebaseTodosListUpdate
    ]
